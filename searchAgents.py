...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        return (state[1] or state[0] == self.corners[0]) and (state[2] or state[0] == self.corners[1]) and (state[3] or state[0] == self.corners[2]) and (state[4] or state[0] == self.corners[3])
